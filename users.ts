function rpcUsers(ctx: nkruntime.Context, logger: nkruntime.Logger, nk: nkruntime.Nakama, payload: string): string {
    const users = nk.sqlQuery(`SELECT id, facebook_id, google_id, steam_id, custom_id, username, 
